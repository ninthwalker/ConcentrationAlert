...
There is zero configuration for this addon. It will record/update current crafting concentration whenever you open your crafting window or use concentration when crafting.
...
#### Desktop App
   1. Download Files in Standalone to your computer.
